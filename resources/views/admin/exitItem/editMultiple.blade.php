...
@section('title')
Edit Transaksi barang keluar page
@endsection
...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="page-titles">
            {{ Breadcrumbs::render('editMultipleExitItem') }}
        </div>
        <div class="row">
            @include('session')
            <div class="col-12">
                <div class="card" style="height: auto;">
                    ...
                    <form action="{{ route('admin.exitItem.updateMultiple') }}" method="post">
                        <div class="card-body">
...
<script>
    $(document).ready(function(e){      
        var table = $('#dataTable').DataTable({
            ajax: {
                url: '{{route("admin.exitItem.loadDataTableEditMultiple")}}'
            },
            processing: true,
            serverSide: true,
            columns: [
