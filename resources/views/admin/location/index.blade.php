            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Lokasi barang</h4>
                    </div>
                    <div class="card-body">
                        <div class="mb-2">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalFormLabel">Form Lokasi</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-valide form-submit" action="{{ route('admin.location.store') }}" method="post"
...
<div class="modal fade" id="modalImport" tabindex="-1" aria-labelledby="modalImportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-valide form-submit-import" action="{{ route('admin.location.import') }}" method="post"
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('input[name="name_location"]').val(result.name_location);
