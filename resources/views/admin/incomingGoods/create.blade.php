...
@section('title')
Tambah Transaksi barang masuk page
@endsection
...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="page-titles">
            {{ Breadcrumbs::render('createIncomingGoods') }}
        </div>
        <div class="row">
            <div class="col-12">
                @include('session')
            ...
            <div class="col-12">
                <div class="card" style="height: auto;">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <form action="{{ route('admin.incomingGoods.store') }}" method="post">
                                @csrf
...
<script>
    $(document).ready(function(e){      
        var table = $('#dataTable').DataTable({
            ajax: {
                url: '{{route("admin.incomingGoods.loadDataTable")}}'
            },
            processing: true,
            columns: [
        ...
        $(document).on('click','.btn-choose',function(e){
            ...
            $.ajax({
                url: '/admin/incomingGoods/'+valStockStore+'/postCart',
                type: 'post',
                dataType: 'json',
        ...
        $(document).on('change','.input-stock',function(e){
            ...
            $.ajax({
                url: '/admin/incomingGoods/'+id+'/updateCart',
                type: 'post',
                method: 'put',
                dataType: 'json',
                data: {
