...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="page-titles">
            {{ Breadcrumbs::render('incomingGoods') }}
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        @can('user-admin')
                        <div class="mb-2">
                            <a href="{{ route('admin.incomingGoods.create') }}"
                                class="btn-add btn btn-primary shadow mr-1">
                                <i class="fas fa-plus"></i> Tambah data
                            </a>
                            <a href="{{ route('admin.incomingGoods.editMultiple') }}"
...
<div class="modal fade" id="modalForm" tabindex="-1" aria-labelledby="modalFormLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-valide form-submit" action="{{ route('admin.incomingGoods.store') }}" method="post"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="stock_incoming_goods">Jumlah stock
                                </label>
                                <div class="col-lg-8">
                                    <input type="number" class="form-control" id="stock_incoming_goods"
                                        name="stock_incoming_goods" placeholder="Jumlah stock..." value="">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function(e){
        ...
        $('.select2-stock-store').select2({
            theme: "bootstrap",
            ajax: {
                url: '{{ route("admin.incomingGoods.create") }}',
                type: 'get',
                dataType: 'json',
                delay: 250,
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('input[name="stock_incoming_goods"]').val(result.stock_incoming_goods);
        ...
        $(document).on('click','#check_id_all', function(e){
            ...
            $.ajax({
                url: '{{ route("admin.incomingGoods.checkedPostMultiple") }}',
                type: "POST",
                method: 'post',
                data: {
                    id: value,
        ...
        $(document).on('click','.check_id', function(){
            ...
            $.ajax({
                url: '{{ route("admin.incomingGoods.checkedPost") }}',
                type: "POST",
                method: 'post',
                data: {
                    id: value,
